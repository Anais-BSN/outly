...
export const DiscussionTab: React.FC<DiscussionTabProps> = ({
  ...
  return (
    <div
      className="flex flex-col h-[calc(100dvh-125px)] sm:h-[calc(100dvh-135px)] max-w-4xl mx-auto"
      onClick={() => {
    ...
    >
      ...
      >
        ...
        {displayedMessages.map((message, index) => {
          ...
          const isMenuOpen = activeContextMenuId === message.id;
          const isPickerOpen = activePickerId === message.id;
          ...
          return (
            ...
            >
              ...
              <div
                ...
                onContextMenu={(e) => {
                  e.preventDefault();
                  setActiveContextMenuId(message.id);
                }}
              >
                {/* Barre d'action contextuelle (Survol PC & Appui long Mobile) */}
                <div
                ...
                >
                  ...
                  <div className="relative">
                    <button
                      type="button"
                      onClick={() => setActivePickerId(isPickerOpen ? null : message.id)}
